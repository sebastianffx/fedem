        ...
        for cur_epoch in range(global_epoch*local_epoch):
            ...
            for batch_data in self.train_loader:
                ...
                if cur_epoch%5==0 and epoch_loss==0:
                    nib.save(nib.Nifti1Image(inputs[0,0,:,:].cpu().numpy(), vol_affine), os.path.join(".", "output_viz", "viz_input_epoch"+str(cur_epoch)+"_adc.nii.gz"))
                    nib.save(nib.Nifti1Image(y_pred_generic[0,0,:,:].cpu().numpy(), vol_affine), os.path.join(".", "output_viz", "viz_input_epoch"+str(cur_epoch)+"_pred.nii.gz"))
                    nib.save(nib.Nifti1Image(labels[0,0,:,:].cpu().numpy(), vol_affine), os.path.join(".", "output_viz", "viz_input_epoch"+str(cur_epoch)+"_label.nii.gz"))
